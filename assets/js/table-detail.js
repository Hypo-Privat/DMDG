...
$('.TableInfo').html('<h3>If you see there are wrong information or description for this tableinfo <br>please send a mail ' 
	+ ' <a href="mailto:BSF-COS@cardcenter.ch?subject=Table correction (' + env + '.' + table + ')" target="_top"> E-Mail</a></h3>' 
			...
			$.each(data,
				...
				var iso = date.toISOString();
					$('.TableDetail').html('<b>' + Sprache.resulttabreq 
						...
						+ '<tr><td>'+ Sprache.ucc + '</td> <td>' + daten.TUSE_UCC + '</td>' + '<td>'+ Sprache.ods + '</td> <td>' + daten.TUSE_ODS + '</td>' 
