/*
 * für externe kunden identifizieren
 ...
 * 
 * @param onNewIP
 *            {Function} listener function to expose the IP locally
 * @return undefined
 */
...
getUserIP(function(ip) {
	...
	// alert('Got your IP ! : ' + ip + " | verify in http://www.whatismypublicip.com/");
	//document.getElementById("ip").innerHTML = 'Got your IP ! : ' + ip + " | verify in http://www.whatismypublicip.com/";
	
	window.localStorage.setItem('userIP', ip);
