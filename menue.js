...
// ausgabe kopf DGDM
	...
	$('#Head').html('<table ><tr align="right">'
		// +'<td><img src="../assets/js/images/frog.jpeg" height="60"
		// width="100"></td>'
			+'<td><h2>'+ Sprache.titel + '</h2></td>'
		// +'<td><img src="../assets/js/images/einstein.jpeg" height="70"
		// width="100"></img></td>'
			+'</tr></table><hr>'
			);
	...
	// ausgabe Webstrings
	$('#Web_Head').html('<h2>' + Sprache.titel_short + '</h2><h3>' +  Sprache.titel + '</h3>' );
	$('#Web_Welcome').html(Sprache.web_welcome);
	$('#Web_Welcome_txt').html(Sprache.web_welcome_txt 
			+ Sprache.web_welcome_txt1
			+ '' +Sprache.web_welcome_txt2
			+ '' + Sprache.web_welcome_txt3
			+ '' +Sprache.web_welcome_txt4
			+ '' +Sprache.web_welcome_txt5 + ''
			);
	$('#Web_Database').html(Sprache.web_databases);
	$('#Web_System').html(Sprache.web_system);
	$('#Web_Functionen').html(Sprache.web_functions);
	$('#Web_About').html(Sprache.web_about);


	$('#Web_Menue').html('<a href="index.html">dmdg</a>'
			+ '   --   ' + '<a href="#" onclick="window.location.reload(); getLang(' + "'de" + "'" + ')">'+ Sprache.de + '</a>'
			+ '   --   ' +'<a href="#" onclick="window.location.reload();  getLang(' + "'en" + "'" + ')">'+ Sprache.en + '</a>'
			+ '   --   ' +'<a href="#" onclick="window.location.reload(); getLang(' + "'es" + "'" + ')">'+ Sprache.es + '</a>'
			+ '   --   ' +'<a href="#" onclick="window.location.reload(); getLang(' + "'fr" + "'" + ')">'+ Sprache.fr + '</a>'
			+ '   --   ' +'<a href="#" onclick="window.location.reload(); getLang(' + "'it" + "'" + ')">'+ Sprache.it + '</a>'
			+ '   --   ' +'<a href="mailto:support@dmdg.io?subject=dmdg Help" target="_top">Contact</a>'
	);
...
// für live demo sonnst prüfen login
		var update = '<li><a href="tableupdate.html" class="signout">'+ Sprache.update + '</a></li>' ;
		var config = '<li><a href="configuration.html">'+ Sprache.config + '</a></li>';
...
// +'<li><a href="packagelist.html">'+ Sprache.pack + '</a></li>'
	...
	+'<ul>'
	+'<li><a href="#" onclick="window.location.reload(); getLang(' + "'de" + "'" + ')">'+ Sprache.de + '</a></li>'
	+'<li><a href="#" onclick="window.location.reload(); getLang(' + "'en" + "'" + ')">'+ Sprache.en + '</a></li>'
	+'<li><a href="#" onclick="window.location.reload(); getLang(' + "'es" + "'" + ')">'+ Sprache.es + '</a></li>'
	+'<li><a href="#" onclick="window.location.reload(); getLang(' + "'fr" + "'" + ')">'+ Sprache.fr + '</a></li>'
	+'<li><a href="#" onclick="window.location.reload(); getLang(' + "'it" + "'" + ')">'+ Sprache.it + '</a></li>'	
	+'</ul></li>'
