...
if ($function === 'saveTable') {
    ...
    $sql = "INSERT INTO TNEWTAB (
		...
		TCID   , TCID_RULES   , TUSE_UCC  , TUSE_DWH   , TUSE_ODS   , TUSE_CWF, 
     ...
     values 
        ('" . $TREQUESTSTRING . "' ,'" . $TBNAME . "' ,'" . $TOWNER . "' ,'" . $TDBA . "' ,'" . $TDATABASE . "' ,'" . $TBSPACE . "' ,'" . $TDOMAIN . "' ,'" . $THOUSEKEEPING . "' ,'" . $TREL_TYPE . "' ,'" . $TREL_RULES . "' ,'" . $THOUSE_RULES . "' ,'" . $TTYPE . "' ,'" . $TCID . "' ,'" . $TCID_RULES . "' ,'" . $TUSE_UCC . "' ,'" . $TUSE_DWH . "' ,'" . $TUSE_ODS . "' ,'" . $TUSE_CWF . "' ,'" . $TUSE_IWF . "' ,'" . $TUSE_OWF . "' ,'" . $TUSE_DEP_MANAGER . "' ,'" . $TDESCRIPTION . "' ,'" . $TENTITY_DESCRIPTION . "' ,'" . $VER_NR . "' ,'" . $VER_DESCRIPTION . "' ,'" . $VER_CHANGE_DATE . "' ,'" . $VER_CHANGE_NR . "' ,'" . $VER_RESPONSIBLE . "','" . $TIMESTAMP . "')";
